...
const Business = () => {
  ...
  <Grid container spacing={4} className="business-grid my-2">
    <Grid item xs={12} md={4}>
      <Paper className="services-paper d-flex flex-column h-100" elevation={3}>
        <img src={cityImage} alt="Intercity Delivery" className="business-image" />
        <Typography variant="h5" className="business-subtitle mt-auto">
          INTERCITY DELIVERY
        </Typography>
    ...
    <Grid item xs={12} md={4}>
      <Paper className="services-paper d-flex flex-column h-100" elevation={3}>
        ...
        <Typography variant="body1" className="business-description">
          Fast payment processing in logistics is essential for streamlining financial transactions between clients, suppliers, and service providers.
        </Typography>
      </Paper>
    </Grid>
    <Grid item xs={12} md={4}>
  ...
  <Grid container spacing={4} className="logistics-grid">
    <Grid item xs={12} md={6}>
      <Paper className="logistics-paper d-flex flex-column h-100" elevation={3}>
        <img src={globalImage} alt="Global Logistics" className="logistics-image" />
        <Typography variant="h5" className="logistics-subtitle mt-auto">
...
<Container className="shipping-procedure-container my-4">
